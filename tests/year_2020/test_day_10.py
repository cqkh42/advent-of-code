"""Tests for day 10 of 2020's Advent of Code."""
import pytest
...
def test__num_routes(num, answer) -> None:
    chain = ((1, 2, 3), (2, 3), (3,), (6,), 0, 0, (9,), 0, 0, tuple())
    assert day_10._num_routes(num, chain) == answer


@pytest.mark.parametrize("data, answer", zip(_data, [35, 220]))
def test_part_a(data, answer) -> None:
    assert day_10.part_a(data) == answer


@pytest.mark.parametrize("data, answer", zip(_data, [8, 19208]))
